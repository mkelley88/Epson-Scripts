...
@license: GPL
 ...
 - I am using Pillow to provide the Python Imaging Library (PIL)
...
# Will be used to change baud rate on TM-T88IV and newer printers
...
print(im.size[0],"x",im.size[1])  # DEBUG # These lines may be removed
print(imgWidth,"x",imgHeight)     # DEBUG #
printIt(imgWidth,imgHeight)       # Keep this line!
